            ...
            <tr>
                <td>
                    ...
                    <div style="padding: 40px; color: #475569;">
                        <h2 style="margin: 0 0 20px; font-size: 22px; color: #ef4444; text-align: center; font-weight: 600;">流量使用预警</h2>
                        
                        <p style="margin: 0; font-size: 15px; line-height: 1.7; text-align: center; color: #64748b;">
                            尊敬的用户您好：
                        </p>

                        <p style="margin: 20px 0 0; font-size: 16px; line-height: 1.7; color: #1e293b; font-weight: 600; text-align: center;">
                            您的流量已使用已达到 <span style="color: #ef4444;">95%</span>。
                        </p>

                        <p style="margin: 10px 0 0; font-size: 14px; line-height: 1.7; color: #64748b; text-align: center;">
                            请合理安排流量使用，以免影响正常访问。  <br>
                            若需要更多流量，请尽快升级套餐！
                        </p>
